    ...
    <CRMLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Общая статистика и последние заявки</p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-blue-600 mt-1">{stats?.requestsByStatus.new}</p>
              </div>
              <div className="bg-blue-100 p-3 rounded-lg">
                <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-yellow-600 mt-1">{stats?.requestsByStatus.in_progress}</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-2xl font-bold text-green-600 mt-1">{stats?.requestsByStatus.completed}</p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow">
                ...
                {recentRequests.map((request) => (
                  <tr key={request.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <Link to={`/requests/${request.id}`} className="text-blue-600 hover:underline font-medium">
          ...
          <div className="p-4 border-t">
            <Link to="/requests" className="text-blue-600 hover:underline text-sm font-medium">
