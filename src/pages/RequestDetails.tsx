...
export const RequestDetails: React.FC = () => {
  ...
  if (error || !request) {
    return (
      <CRMLayout>
        <div className="text-center mt-20 text-red-600">{error || 'Заявка не найдена'}</div>
      </CRMLayout>
    );
  }
    ...
    <CRMLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <Link to="/requests" className="text-blue-600 hover:underline text-sm mb-2 inline-block">
              ← Назад к списку
            </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Works/Services */}
            <div className="bg-white rounded-lg shadow p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4">Работы и услуги</h2>
              ...
              {request.works && request.works.length > 0 ? (
                <div className="overflow-x-auto mb-6">
                  <table className="w-full">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="px-4 py-2 text-left text-sm font-medium text-gray-500">Наименование</th>
                ...
                <p className="text-gray-500 mb-6">Работы еще не добавлены</p>
              )}

              {/* Add work form */}
              <div className="border-t pt-4">
                <h3 className="font-medium text-gray-900 mb-3">Добавить работу</h3>

                {/* Quick services */}
                <div className="mb-4">
                  <p className="text-sm text-gray-500 mb-2">Частые услуги:</p>
                ...
                <div className="space-y-3">
                  {request.statusHistory.map((history, index) => (
                    <div key={history.id || index} className="flex items-center gap-3 text-sm">
                      ...
                      {history.changedBy && <span className="text-gray-500">({history.changedBy})</span>}
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="space-y-6">
            {/* Update status */}
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="font-bold text-gray-900 mb-3">Изменить статус</h3>
              <Select
                value={newStatus}
            ...
            {/* Assign master */}
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="font-bold text-gray-900 mb-3">Назначить мастера</h3>
              <Select
            ...
            {/* Update progress */}
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="font-bold text-gray-900 mb-3">Прогресс выполнения</h3>
              <div className="mb-3">
            ...
            {/* Payment status */}
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="font-bold text-gray-900 mb-3">Статус оплаты</h3>
              <Select
                value={paymentStatus}
            ...
            {request.trackingToken && (
              <div className="bg-blue-50 rounded-lg p-4">
                <h3 className="font-bold text-gray-900 mb-2 text-sm">Ссылка для отслеживания</h3>
                <a
